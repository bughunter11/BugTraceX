...
def update_tool():
    ...
    raw_version_url = "https://raw.githubusercontent.com/bughunter11/BugTraceX/main/version.txt"
    ...
    try:
        with open(version_file, "r") as vf:
            ...
            if not local_version.replace(".", "").isdigit():
                raise ValueError
    except:
        local_version = "0.0"
    ...
    try:
        api_url = "https://api.github.com/repos/bughunter11/BugTraceX/contents/version.txt"
        ...
        try:
            r = requests.get(raw_version_url, headers={"Cache-Control": "no-cache"})
    ...
    # === Step 4: Download updated script
