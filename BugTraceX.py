...
def update_tool():
    ...
    version_file = os.path.expanduser("~/version.txt")  # ✅ Local version file path
    ...
    try:
        ...
        local_version = "0.0"  # Default version if not found
    ...
    try:
        ...
        if not remote_version.replace(".", "").isdigit():
            raise ValueError("Invalid remote version format")
